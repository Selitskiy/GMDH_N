function [X, Y, B, XI, C, k_ob] = w_seriesa_train_tensors(M, m_in, n_out, l_sess, n_sess, norm_fl)

    % Number of observations in a session (fitting full input size series, 
    % don't care if labels go into another session)
    k_ob = l_sess - m_in;        
